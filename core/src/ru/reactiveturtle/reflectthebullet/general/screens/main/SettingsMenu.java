...
public class SettingsMenu extends Stage {
    ...
    private Slider getSlider(float progress, float width, float y) {
        ...
        sliderStyle.knob = new TextureRegionDrawable(new Texture(
                PixmapHelper.getCirclePixmap(Color.valueOf("#ff6f00"), displayMetrics.widthPixels() / 24, displayMetrics.widthPixels() / 24)));
        sliderStyle.knobBefore = new TextureRegionDrawable(new Texture(
                PixmapHelper.getRectPixmap(Color.valueOf("#689f38"), displayMetrics.widthPixels() / 4, displayMetrics.widthPixels() / 128)));
        sliderStyle.background = new TextureRegionDrawable(new Texture(
                PixmapHelper.getRectPixmap(Color.GRAY, displayMetrics.widthPixels() / 4, displayMetrics.widthPixels() / 128)));
